...
from pharmacy_os.core.observability import register_metrics_endpoint, register_observability
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    register_metrics_endpoint(app, settings.app.metrics_token.get_secret_value())
