...
2. **Văn bản pháp lý thiếu (Bước 1.1/1.8) — ĐÃ BỔ SUNG PHẦN LỚN (2026-07-23).** Sếp đã thả: **Luật BVDLCN 91/2025/QH15**, **NĐ 356/2025/NĐ-CP** (hướng dẫn thi hành), **GPP** (TT02/2018 + sửa đổi TT11/2025 + TT29/2020). Đã đọc toàn bộ + tóm tắt vào `docs/legal/*.SUMMARY.md` (xem `docs/legal/README.md` mục lục). **Còn thiếu:** bản thân **Luật Dược hiện hành** (105/2016/QH13 sửa bởi 44/2024/QH15) — mới chỉ có văn bản hướng dẫn thi hành, chưa có luật gốc; không chặn scope hiện tại nhưng cần nếu đối chiếu sâu ETC/OTC. Phát hiện quan trọng từ đọc kỹ NĐ356 Điều 41.2: **miễn trừ DPIA cho hộ kinh doanh/DN siêu nhỏ KHÔNG áp dụng** cho tính năng hồ sơ KH vì dữ liệu dị ứng/bệnh nền là "dữ liệu cá nhân nhạy cảm" (Điều 4.1.d) — mọi tenant dù nhỏ vẫn phải lập DPIA khi bật tính năng này. Cũng phát hiện câu hỏi pháp lý mở cần tư vấn luật sư: BeraLLC có thuộc diện phải xin Giấy chứng nhận đủ điều kiện kinh doanh dịch vụ xử lý DLCN (NĐ356 Điều 21-27, mục 4 liệt kê "phần mềm chăm sóc/theo dõi sức khỏe") hay không — xem `docs/legal/Nghị-định-356-2025-NĐ-CP.SUMMARY.md`.
